...
set ylabel "Time [s]"
set key left top box opaque  # Lepsza legenda
...
plot "data.txt" skip 1 using 1:2 with points lw 2 pt 7 lc rgb "red" title "Measured Time", \
...
plot "data.txt" skip 1 using 1:3 with points lw 2 pt 7 lc rgb "blue" title "Measured Time", \
